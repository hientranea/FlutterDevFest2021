...
class PriceChart extends StatefulWidget {
  ...
  final List<CurrencyPrice> priceHistories = [];

  PriceChart(this.cryptoSymbol, priceHistories, {Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => PriceChartState();
}
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [
              isDarkMode() ? const Color(0xff2c274c) : CryptoTrackerColors.greyBackground,
              isDarkMode() ? const Color(0xff46426c) : CryptoTrackerColors.greyBackground,
            ],
        ...
        child: Stack(
          children: <Widget>[
            ...
            IconButton(
              icon: Icon(
                Icons.refresh,
                color: Theme.of(context).primaryColor.withOpacity(isShowingMainData ? 1.0 : 0.5),
              ),
              onPressed: () {
                setState(() {
...
class _LineChart extends StatelessWidget {
  ...
  FlTitlesData get titlesData2 => FlTitlesData(
        ...
        rightTitles: SideTitles(showTitles: false),
        topTitles: SideTitles(showTitles: false),
        leftTitles: leftTitles(getTitles: (value) => value.toString()),
      );
